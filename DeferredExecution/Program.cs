...
internal class DeferredExecution
{
    internal static void Example1()
    {
        ...
        Console.WriteLine();
        Console.WriteLine($"We will create 2 collections of strings, one using IEnumerable<string>");
        Console.WriteLine($"and the other using List<string>.");
        Console.WriteLine();
        Console.WriteLine($"Both collections will contain a single string: DateTime.Now.ToList()");
        Console.WriteLine();
        ...
        Console.WriteLine();
        Console.WriteLine($"So, by intuition, we would assume values from both collections would");
        Console.WriteLine($"be the same.");
        Console.WriteLine();
        Console.WriteLine($"This is the DateTime of right after both collections were created: {DateTime.Now}");
        Console.WriteLine();
        Console.WriteLine($"Press any key to show the values of both collections.");
        ...
        Console.WriteLine();
        Console.WriteLine($"We can force this to happen earlier by calling IEnumerable<>.ToList().");
        Console.WriteLine($"That's why the collection using List<> got the DateTime.Now from right when");
    ...
    internal static void Example2()
    {
        ...
        Console.WriteLine($"    list = iEnumerable.ToList();");
        Console.WriteLine();
        Console.WriteLine($"By intuition, we would assume values from both collections would");
        Console.WriteLine($"be the same.");
        Console.WriteLine();
    ...
    internal static void Example3()
    {
        ...
        Console.WriteLine();
        Console.WriteLine($"We will use Random() again, this time passing the iEnumerable collection");
        ...
        Console.WriteLine($"As we can see, every time we enumrate the IEnumerable<>, a new random");
        Console.WriteLine($"number is generated. Surely it can be useful in some specific situations,");
        Console.WriteLine($"but it can cause a big headache if we implement it this way without knowing");
